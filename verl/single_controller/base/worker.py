...
class Worker(WorkerHelper):
    ...
    def _setup_env_cuda_visible_devices(self):
        ...
        if is_ray_noset_visible_devices:
            ...
            # Ray's default CUDA isolation sets CUDA_VISIBLE_DEVICES to the
            # physical GPU id(s) before the actor starts.  Inside that masked
            # process, torch devices are re-indexed from zero.
